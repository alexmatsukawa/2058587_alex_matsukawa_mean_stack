...
function addItem1() {
    ...
    var itemName1 = (document.getElementById('item-1-name') as HTMLParagraphElement).innerHTML;
    console.log(itemName1);
    var itemPrice1 = (document.getElementById('item-1-price') as HTMLParagraphElement).innerHTML;
...
function addItem2() {
    ...
    var itemName2 = (document.getElementById('item-2-name') as HTMLParagraphElement).innerHTML;
    var itemPrice2 = (document.getElementById('item-2-price') as HTMLParagraphElement).innerHTML;
...
function addItem3() {
    ...
    var itemName3 = (document.getElementById('item-3-name') as HTMLParagraphElement).innerHTML;
    var itemPrice3 = (document.getElementById('item-3-price') as HTMLParagraphElement).innerHTML;
...
function addItem4() {
    ...
    var itemName4 = (document.getElementById('item-4-name') as HTMLParagraphElement).innerHTML;
    var itemPrice4 = (document.getElementById('item-4-price') as HTMLParagraphElement).innerHTML;
